- **Spectroscopic Data Processing**
  - [Be_grism_proc_auto_JRM_new.ipynb](Be_grism_proc_auto_JRM_new.ipynb)
  ...
  - [grism_utils_v2.py](grism_utils_v2.py)
    ...
    science spectra
  - [STELIB](STELIB/), [ESO](ESO/), [CALSPEC](CALSPEC/)
  ...
  - [Grism_Focus_Optimizer.ipynb](Grism_Focus_Optimizer.ipynb)
  ...
  - [RLMT_stack_to_BeSS.ipynb](RLMT_stack_to_BeSS.ipynb)
...
- **Spectroscopic Data Analysis**
  - [Be_Spectral_Analysis_Master_Local.ipynb](Be_Spectral_Analysis_Master_Local.ipynb)
    ...
    systems.
    - [fit_utils.py](fit_utils.py)
      - This contains various functions supporting `Be_Spectral_Analysis_Master_Local.ipynb`
  - [Simplified_Spectral_Analysis.ipynb](Simplified_Spectral_Analysis.ipynb)
    ...
    - [simplified_fit_utils.py](simplified_fit_utils.py)
      - Same as `fit_utils.py` but for this notebook
  - [Model_Spectra_Fitting.ipynb](Model_Spectra_Fitting.ipynb)
    ...
    - [model_spectra_utils.py](model_spectra_utils.py)
...
- **Other Resources**
  ...
  - [bess_access.ipynb](bess_access.ipynb)
  ...
  - [bess_downloads](bess_downloads/)
    - Folder containing various downloaded bess spectra
  - [get_grism_data.py](get_grism_data.py)
